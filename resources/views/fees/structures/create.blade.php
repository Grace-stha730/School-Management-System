            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-plus-circle text-primary"></i> Create Fee Structure
                    </h1>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('fee_head_id') is-invalid @enderror" 
                                        ...
                                        @foreach($fee_heads as $head)
                                            <option value="{{ $head->id }}" {{ old('fee_head_id') == $head->id ? 'selected' : '' }}>
                                                {{ $head->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              name="description" 
                                              rows="3" 
                                              placeholder="Optional description or notes about this fee structure">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
